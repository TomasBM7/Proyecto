...
<div id="modal-delete-{{$estados->id}}" class="flex items-center justify-center fixed left-0 bottom-0 w-full h-full bg-gray-800">
  ...
  <form action="{{route('estado.destroy',$estados->id)}}" method="POST">
    ...
    <div class="flex flex-col items-start p-4">
      ...
      <hr>
      <div class="">¿Desea eliminar {{$estados->apellidos." ".$estados->nombre}} del registro del estadoss?</div>
      <hr>
      <div class="ml-auto">
