...
<div id="modal-delete-{{$despensas->id}}" class="flex items-center justify-center fixed left-0 bottom-0 w-full h-full bg-gray-800">
  <div class="bg-white rounded-lg w-1/2">
  <form action="{{route('despensa.destroy',$despensas->id)}}" method="POST">
    @csrf
    @method('DELETE')
    <div class="flex flex-col items-start p-4">
      ...
      <hr>
      <div class="">¿Desea eliminar {{$despensas->apellidos." ".$despensas->nombre}} del registro del despensass?</div>
      <hr>
      <div class="ml-auto">
