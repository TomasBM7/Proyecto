...
<div id="modal-delete-{{$personal->id}}" class="flex items-center justify-center fixed left-0 bottom-0 w-full h-full bg-gray-800">
  ...
  <form action="{{route('personal.destroy',$personal->id)}}" method="POST">
    ...
    <div class="flex flex-col items-start p-4">
      ...
      <hr>
      <div class="">¿Desea eliminar {{$personal->apellidos." ".$personal->nombre}} del registro del personal?</div>
      <hr>
      <div class="ml-auto">
