        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div class="w-full bg-gray-900 rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                ...
                <div class="text-center">
                    <p class="text-xl text-white font-bold mb-2">Despensas</p>
                </div>
            </div>
            ...
            <div class="w-full bg-gray-900 rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                ...
                <div class="text-center">
                    <p class="text-xl text-white font-bold mb-2">Cargos</p>
                </div>
            </div>
            ...
            <div class="w-full bg-gray-900 rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                ...
                <div class="text-center">
                    <p class="text-xl text-white font-bold mb-2">Turnos</p>
                </div>
            </div>
            ...
            <div class="w-full bg-gray-900 rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                ...
                <div class="text-center">
                    <p class="text-xl text-white font-bold mb-2">Estados</p>
                </div>
            </div>

            <div class="w-full bg-gray-900 rounded-lg sahdow-lg p-12 flex flex-col justify-center items-center">
                <div class="mb-8">
                    <a href="{{route('multa.index')}}">
                    <img class="object-center object-cover rounded-full h-36 w-36" src="https://images.unsplash.com/flagged/photo-1570612861542-284f4c12e75f?ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&ixlib=rb-1.2.1&auto=format&fit=crop&w=1170&q=80" alt="photo">
                    </a>
                </div>
                <div class="text-center">
                    <p class="text-xl text-white font-bold mb-2">Multas</p>
                </div>
            </div>
    </section>
</div>
