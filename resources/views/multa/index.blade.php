                    ...
                    <div class="rounded-t mb-0 px-4 py-3 border-0">
                      <div class="flex flex-wrap items-center">
                        <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                          <h3 class="font-semibold text-base text-blueGray-700">Lista de Multas</h3>
                        </div>
                      ...
                      <table class="items-center bg-transparent w-full border-collapse ">
                        ...
                        <tbody>
                          ...
                          <th class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left text-blueGray-700 ">
                            <a href="{{route('multa.show',$multa->id)}}">
                              {{$multa->nombre_multa}}</a>
                            </th>
                            <th class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-left text-blueGray-700 ">
                              {{$multa->Descripción}}
                            </th>
                          ...
                          <span class="inline-block w-1/3 md:hidden font-bold">Acciones</span>
                            <form action="{{route('multa.destroy', $multa->id)}}" method="POST" >
                              @csrf 
                              @method('delete')
                          ...
                          <a class="bg-indigo-500 text-white active:bg-indigo-600 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button"
                          href="{{route('multa.show',$multa->id)}}"
                          >Mostrar</a>
                          @endforeach
                        </tbody>
