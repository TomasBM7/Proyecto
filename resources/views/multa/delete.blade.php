...
<div id="modal-delete-{{$multas->id}}" class="flex items-center justify-center fixed left-0 bottom-0 w-full h-full bg-gray-800">
  <div class="bg-white rounded-lg w-1/2">
  <form action="{{route('multa.destroy',$multas->id)}}" method="POST">
    @csrf
    @method('DELETE')
    <div class="flex flex-col items-start p-4">
      ...
      <hr>
      <div class="">¿Desea eliminar {{$multas->apellidos." ".$multas->nombre}} del registro del multass?</div>
      <hr>
      <div class="ml-auto">
